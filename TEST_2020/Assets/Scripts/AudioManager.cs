...
public class AudioManager : MonoBehaviour
{
	...
	{
		ctrl = this;
		bgmDB = (SoundDB)Resources.Load("BGMDB",typeof(SoundDB));
		sfxDB = (SoundDB)Resources.Load("SFXDB",typeof(SoundDB));
		/*
		using(FileStream stream =  File.Open(Application.streamingAssetsPath + "/BGMDB", FileMode.Open)) 
		{ 
			//處理方法 
		} 
		*/
